    ...
    <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-[1fr_400px] gap-12 lg:gap-20 items-center">
      <div className="animate-invite-float-up" style={{ animationDelay: '0.1s' }}>
        ...
        <h1 className="font-display font-bold leading-[0.92] tracking-[-0.04em] mb-8">
          <span className="block text-[clamp(2.5rem,8vw,7rem)] text-[oklch(0.94_0.006_155)]">Replique.</span>
          <span
          ...
          <span className="block text-[clamp(2.5rem,8vw,7rem)] text-[oklch(0.94_0.006_155)]/30">Vença.</span>
        </h1>
        ...
        <div className="flex items-start gap-6">
          ...
          />
          <p className="text-base text-[oklch(0.52_0.018_152)] leading-relaxed max-w-sm">
            Conecte a sua conta na Bull-ex, convide seguidores pelo portal e acompanhe as operações replicadas em tempo real — com
        ...
        <div className="relative">
          ...
          <div className="relative bg-[oklch(0.095_0.01_155)]/70 backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-8 overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative">
              <div>
                <label className="block text-xs font-semibold text-[oklch(0.52_0.018_152)] mb-2 tracking-wide">E-mail</label>
                <input
                  type="email"
                  value={email}
              ...
              <div>
                <label className="block text-xs font-semibold text-[oklch(0.52_0.018_152)] mb-2 tracking-wide">Senha</label>
                <div className="relative">
                  <input
            ...
            <div className="mt-6 pt-6 border-t border-white/[0.06] relative">
              <p className="text-xs text-[oklch(0.52_0.018_152)] text-center leading-relaxed">
                ...
                <span className="text-[oklch(0.94_0.006_155)]/60 font-medium">administrador</span> da plataforma.
              </p>
              <p className="text-center text-xs text-[oklch(0.52_0.018_152)] mt-4 leading-relaxed">
