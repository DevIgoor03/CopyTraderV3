  ...
  return (
    ...
    >
      ...
      <main>
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 lg:items-end">
            ...
            <div className="space-y-8">
              <p className={`text-base leading-relaxed ${marketingMuted} lg:text-lg`}>
                Nossa solução integra operador e seguidores na Bull-ex: o master conecta a conta, os seguidores usam o
        ...
        >
          ...
          >
            <div className="flex flex-col gap-5 lg:flex-row lg:gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex -space-x-2">
                      {[
                        ...
                        <span
                          key={i}
                          className={`inline-flex h-9 w-9 rounded-full border-2 border-[oklch(0.088_0.01_155)] ${c}`}
                        />
                      ))}
                    </div>
              ...
              <div
                className={`relative min-h-[280px] flex-1 overflow-hidden rounded-2xl border ${marketingBorderSubtle} bg-[oklch(0.055_0.01_155)] lg:min-h-[340px]`}
              >
                <div
                  ...
                  style={{
                    background: `
                      ...
                      linear-gradient(135deg, oklch(0.09 0.02 152) 0%, oklch(0.055 0.01 155) 45%, oklch(0.07 0.015 160) 100%)
                    `,
                  }}
                />
                <div
                ...
                >
                  ...
                  <span className={`text-xs font-medium ${marketingMuted}`}>Bull-ex · tempo real</span>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  t: 'Painel master',
                  d: 'Conexão Bull-ex, copy on/off e visão dos seguidores.',
                },
        ...
        <section
          id="contato"
          className={`border-t ${marketingBorderSubtle} bg-[oklch(0.055_0.01_155)] px-5 py-16 lg:px-8 scroll-mt-24`}
        >
