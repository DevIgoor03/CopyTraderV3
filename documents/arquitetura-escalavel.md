...
| **SDK** | @quadcode-tech/client-sdk-js | Bull-ex integration |
...
│  /api/accounts/*     → AccountService (Bull-ex SDK, multi-tenant)│
...
- **AES-256-CBC**: Credenciais Bull-ex criptografadas em repouso
...
| Método | Rota | Descrição |
|--------|------|-----------|
| POST | `/master/connect` | Conectar conta Bull-ex |
...
| Método | Rota | Descrição |
|--------|------|-----------|
| POST | `/:masterId/login` | Login do seguidor (Bull-ex credentials) |
